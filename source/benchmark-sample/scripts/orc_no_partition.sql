...
--
 ...
 create table if not exists inventory              like ${db_txt}.inventory              stored as orc;
 create table if not exists store_sales            like ${db_txt}.store_sales            stored as orc;
 create table if not exists store_returns          like ${db_txt}.store_returns          stored as orc;
 create table if not exists catalog_returns        like ${db_txt}.catalog_returns        stored as orc;
 create table if not exists catalog_sales          like ${db_txt}.catalog_sales          stored as orc;
 create table if not exists web_returns            like ${db_txt}.web_returns            stored as orc;
 create table if not exists web_sales              like ${db_txt}.web_sales              stored as orc;
